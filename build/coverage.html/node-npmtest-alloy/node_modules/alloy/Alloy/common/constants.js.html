...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-alloy/node_modules/alloy/Alloy/common/constants.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-alloy/node_modules/alloy/Alloy/common/constants.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-alloy/node_modules/alloy/Alloy/common/</a> &#187; constants.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var isTitanium = typeof Titanium !== 'undefined';
var _, generatePlatformArray;
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (isTitanium) {
<span class="cstat-no" title="statement not covered" >	_ = require('/alloy/underscore')._;</span>
} else {
...
&nbsp;
	// Ti.UI.iPhone
	NavigationGroup: isTitanium &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Ti.Platform.osname === 'mobileweb' </span>?
<span class="branch-0 cbranch-no" title="branch not covered" >		NS_TI_UI_MOBILEWEB </span>: NS_TI_UI_IPHONE,
